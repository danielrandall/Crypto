...
\footnotetext{http://technet.microsoft.com/en-us/library/cc962035.aspx}
\begin{figure}[!htb]
\centerline{\includegraphics[height=2.5in,width=4in,angle=0]{images/rsaKeyExchange.pdf}}
\caption[Caption for LOF]{A depiction of two users exchanging keys using RSA. The secret key represents a symmetric key owned by the sender.\protect\footnote{http://technet.microsoft.com/en-us/library/cc962035.aspx}}
